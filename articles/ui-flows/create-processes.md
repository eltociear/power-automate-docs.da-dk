...
1.  Når du har oprettet din automatiseringsproces i WinAutomation, kan du køre den fra et flow i Power Automate via flows for brugergrænseflade (stationære computere) eller automatiseret. **Bemærk**! Du kan få mere at vide om, hvordan du opretter og kører flows for brugergrænseflade ved at gå videre [her](https://docs.microsoft.com/power-automate/ui-flows/create-desktop).
